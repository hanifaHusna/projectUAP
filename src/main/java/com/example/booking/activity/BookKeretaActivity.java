...
import com.example.booking.activity.database.DatabaseHelper;
import com.example.booking.activity.session.SessionManager;
...
public class BookKeretaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] asal = {"Jakarta", "Bandung", "Solo", "Malang", "Surabaya"};
        final String[] tujuan = {"Jakarta", "Bandung", "Solo", "Malang", "Surabaya"};
    ...
    public void perhitunganHarga() {
        if (sAsal.equalsIgnoreCase("jakarta") && sTujuan.equalsIgnoreCase("bandung")) {
            ...
            hargaDewasa = 200000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("jakarta") && sTujuan.equalsIgnoreCase("solo")) {
            hargaDewasa = 150000;
            hargaAnak = 120000;
            ...
            hargaDewasa = 120000;
            hargaAnak = 100000;
        } else if (sAsal.equalsIgnoreCase("surabaya") && sTujuan.equalsIgnoreCase("solo")) {
            hargaDewasa = 170000;
            hargaAnak = 130000;
        } else if (sAsal.equalsIgnoreCase("surabaya") && sTujuan.equalsIgnoreCase("malang")) {
            hargaDewasa = 180000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("solo") && sTujuan.equalsIgnoreCase("jakarta")) {
            hargaDewasa = 150000;
            hargaAnak = 120000;
            ...
            hargaDewasa = 80000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("solo") && sTujuan.equalsIgnoreCase("surabaya")) {
            hargaDewasa = 170000;
            hargaAnak = 130000;

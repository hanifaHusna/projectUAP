...
import com.example.booking.activity.adapter.AlertDialogManager;
            ...
            public void onClick(View arg0) {
                ...
                try {
                    ...
                    if (username.trim().length() > 0 && password.trim().length() > 0) {
                        ...
                        alert.showAlertDialog(LoginActivity.this, "Login gagal..", "Mohon isi form dengan lengkap!", false);
                    }
                } catch (Exception e) {
